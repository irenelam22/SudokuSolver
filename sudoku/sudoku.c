...
int main(const int argc, char *argv[]){
    ...
    if ( strcmp(command, "create") == 0){                   // if the command is create...
        ...
        create(file_name, indicator);                       // create the puzzle
    }
    else if ( strcmp(command, "solve") == 0){               // if the command is solve...
        solve(file_name);                                   // solve the provided puzzle
    }
...
static void process_arguments(int argc, char* argv[], char** command, char** file_name){
    ...
    *command = argv[1];                                     // extract the command
    ...
    if ( strcmp(*command, "create") == 0){                  // if the command is "create"...
        ...
        FILE* fp = fopen(*file_name, "w");                  // otherwise, try opening this file for writing
        ...
        FILE* fp = fopen(*file_name, "r");                  // otherwise, try to open this file for reading
